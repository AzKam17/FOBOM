...
if (!utilisateur_est_connecte()) {
    ...
    if ($_SESSION['niveau'] == 1) {
        ...
        if (!empty($_POST['element_2']) AND ! empty($_POST['element_3']) AND ! empty($_POST['element_4']) AND isset($_POST['element_5'])) {
            ...
            if ($idcred = creditsanscheque($code_distrib, $motif, $mtcred, $datecred, $id)) {
                $erreurs_d = 'Le credit à été attribué avec SUCCES!';
            include CHEMIN_VUE.'ajoutcreditconfirm.php';
            } else {
                $erreurs_a = 'Erreur attribution du crédit!';
            include 'modules/credit/ajoutcredit.php';
            }
