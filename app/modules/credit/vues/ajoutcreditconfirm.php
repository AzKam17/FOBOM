...
<section class="invoice">
    ...
    <div class="row no-print">
        <div class="col-xs-12">
            <a href="index.php?module=credit&action=bordereaucred&nom_distrib=<?php echo $nom_distrib; ?>&code_distrib=<?php echo $code_distrib; ?>&idcred=<?php echo $idcred; ?>&mtcred=<?php echo $mtcred; ?>&dad11=<?php echo $dad11; ?>&motif=<?php echo utf8_encode(quelmotif($motif)); ?>" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
        </div>
    </div>
</section>
<!-- /.content -->
