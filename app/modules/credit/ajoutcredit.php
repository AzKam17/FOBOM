...
<section class="content-header">
    <h1>
        Crédit
        <small>Sans Remise de Chèque</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="">Crédit</li>
        <li class="active">Credit sans chèque</li>
    </ol>
</section>
        ...
        <div class="col-md-12">
            <div class="box box-primary box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title">Attribuer un crédit sans cheque</h3>
                ...
                <div class="box-body">
                    <!-- Smart Wizard -->
                    <p>Accorder un nouveau crédit sans dépot de cheque. Les champs en asterix sont obligatoires (*)</p>
                    <form class="form-horizontal form-label-left" id="form" role="form" method="post" autocomplete="off" action="index.php?module=credit&amp;action=newcredit2">
