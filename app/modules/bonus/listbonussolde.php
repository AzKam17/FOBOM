...
<section class="content-header">
    <h1>
        Bonus
        <small>Liste des bonus soldés</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Acceuil</a></li>
        <li class="">Bonus</li>
        <li class="active">Liste Bonus soldés</li>
    </ol>
</section>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary box-solid">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <table id="datatable-buttons_19" class="table table-bordered table-striped dt-responsive nowrap" style="width: 30px; margin-left: 210px;">
                        <thead>
                            <tr>
                                <th>Code distrib</th>
                                <th>Nom Complet</th> 
