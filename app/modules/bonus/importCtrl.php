...
if (!utilisateur_est_connecte()) {
    ...
    if (isset($_POST['datepicker']) and isset($_FILES['fichier']['name']) and $_SESSION['niveau'] == 1) {
        ...
        // Recuperation du nom du fichier(basename or filename)
        ...
        foreach ($worksheetData as $worksheet) {
            ...
            if ($colum == 7) {
                ...
                if (ajoutfichierbonus($idfichier, $nomfich, $rows, $extension, $pays, $moisbonus, $anneebonus)) {
                    ...
                    include 'modules/bonus/bonusimport.php';
                } else { //Le fichier concerné a ete deja uploadé on stop le traitement
                    $erreurs_c = 'Téléchargement impossible, le fichier existe deja.';
                    include 'modules/bonus/bonusimport.php';
                }
            } else {
