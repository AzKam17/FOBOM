        ...
        <div class="col-md-12">
            <div class="box box-primary box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title">Virements Nationaux Mensuels ( <?php echo $moisbonus.'/'.$anneebonus; ?> )</h3>

                    <form action="index.php?module=virement&amp;action=effectvirmensCtrl" method="post" id="imp" role="form">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <table id="datatable-buttons_7" class="table table-bordered table-striped dt-responsive nowrap" style="width: 30px; margin-left: 210px;">
                        <thead>
                            <tr>
                                <th>Code distrib</th>
                                <th>Nom complet</th>
