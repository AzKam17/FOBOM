        ...
        <div class="col-md-12">
            <div class="box box-primary box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title">Cumul des Virements Nationaux en cours</h3>

                    <form action="index.php?module=virement&amp;action=downvireCtrl" method="post" id="" role="form">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <table id="datatable-buttons_10" class="table table-bordered table-striped dt-responsive nowrap" style="width: 30px; margin-left: 180px;">
                        <thead>
                            <tr>
                                <th>Code distrib</th>
                                <th>Nom complet</th>
                        ...
                        <tbody>
                            <tr class="gradeA">
                                <td align="center" colspan="6">Chargement de la liste des cumul de virements nationaux en cours...</td>
                            </tr>
                        </tbody>
                        <tfoot>
                            <tr>
