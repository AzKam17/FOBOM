...
<section class="content-header">
    <h1>
        Virement
        <small>Liste des virements en cours</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="">Transaction</li>
        <li class="active">Virement en cours</li>
    </ol>
</section>
        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="box box-primary box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title">Virement en Cours</h3>
                ...
                <!-- /.box-header -->
                <form action="index.php?module=virement&amp;action=virementcourCtrl" method="post" id="imp" role="form">   
                    <div class="box-body">
                        <div class="row">
