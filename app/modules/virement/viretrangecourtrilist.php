        ...
        <div class="col-md-12">
            <div class="box box-primary box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title">Virements Internationaux Mensuels en cours du  <?php echo $moisbonus.'/'.$anneebonus; ?> </h3>

                    <form action="index.php?module=virement&amp;action=downviretrangmensCtrl" method="post" id="" role="form">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <table id="datatable-buttons_13" class="table table-bordered table-striped dt-responsive nowrap" style="width: 30px; margin-left: 35px;">
                        <thead>
                            <tr>
                                <th>Code distrib</th>
                                <th>Nom complet</th>
