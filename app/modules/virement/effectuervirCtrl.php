...
if ($_SESSION['niveau'] == 1) {
    ...
    $listvir = liste_vire_etrang_cumul();
    ...
    if (empty($listvir)) {//SI les tableau est vide dc on ne peut pas ordonner de virement
        ...
        $erreurs_d = $succes.' virement(s) internationaux de bonus ont été ordornné avec succes !';
        if($fail !== 0){
        $erreurs_b = $fail.' virement(s) internationaux de bonus n\'ont pas pu etre ordornné !';
        }
        include 'modules/virement/virechoix.php';
    }
} else {
