...
if ($_SESSION['niveau'] == 1) {
    ...
    if (empty($listvir)) {//SI les tableau est vide dc on ne peut pas ordonner de virement
        ...
        $erreurs_d = $succes.' virement(s) nationaux de bonus ont été ordornné avec succes !';
        if($fail !== 0){
        $erreurs_b = $fail.' virement(s) nationaux de bonus n\'ont pas pu etre ordornné !';
        }
        include 'modules/virement/virechoix.php';
    }
} else {
