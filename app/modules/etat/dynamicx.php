            ...
            <div class="box box-primary box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title">Etat des bonus <?php
                        ...
                        ?> de la periode de paiement du ( <?php echo $dapdep; ?> ) au ( <?php echo $dapfin; ?> )</h3>
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <table id="datatable-buttons_17" class="table table-bordered table-striped dt-responsive nowrap" style="width: 30px; margin-left: 220px;">
                        <thead>
                            <tr>
                                <th>Code distrib</th>
                                <th>Nom complet</th>
